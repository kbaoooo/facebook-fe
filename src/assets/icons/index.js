...
export const HomeIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 24 24"
            width="24"
            ...
            onClick={onClick}
            {...props}
            className={`x19dipnz x1lliihq x1k90msu x2h7rmj x1qfuztq ${className}`}
        >
...
export const FriendsIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 24 24"
            width="24"
...
export const VideoIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 24 24"
            width="24"
...
export const MarketIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 24 24"
            width="24"
...
export const GameIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 24 24"
            width="24"
...
export const FacebookIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 36 36"
            ref={ref}
...
export const MenuIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 24 24"
            width="20"
...
export const MessIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 12 13"
            width="20"
...
export const NotiIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 24 24"
            width="20"
...
export const ArrowDownIcon = forwardRef(({ className, onClick, ...props }, ref) => {
    return (
        <svg
            viewBox="0 0 16 16"
            width="20"
